...
################################################下面为第二个功能########################################################
    def show_data_analysis(self):
        ...
        self.page_label = ctk.CTkLabel(nav_frame, text="", font=("Arial", 12))
    ...
    def update_page_label(self):    #更新页码
        total_pages = (len(self.datasets) + self.items_per_page - 1) // self.items_per_page
        self.page_label.configure(text=f"第 {self.current_page} 页 / 共 {total_pages} 页")
